...
* Filesystems And Storage (Long-Term Archiving, Client-Server Filesystems,
  Compression)
...
We will have a board of reviewers for the papers and fairly pick the speakers
in a transparent manner.
1. National and International F/LOSS/open knowledge/open hardware speakers.
2. Status reports from local and regional hacklabs/lugs/makerspaces etc
3. Local regional developers presenting projects they are working on.

## Schedule
See [Schedule Page](/pages/schedule.html)
